                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    <label for="customer_name" class="col-sm-5">Appointment No. <i
                                            class="text-danger">*</i></label>
                                    <div class="col-sm-7">
                                        <input required="" autocomplete="off" value="<?php echo $invo->patient_phone; ?>"
                                            name="phone" id="phone" class="form-control" type="text">
                                        <span id="csc"
                                            class="text-center invlid_patient_id">Appointment No.</span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="customer_name" class="col-sm-5"><?php echo display('patient_name') ?> <i
                                            class="text-danger">*</i></label>
                                    <div class="col-sm-7">
                                        <input required="" value="<?php echo $invo->family_name; ?>" name="patient_name"
                                            id="patient_name" class="form-control" type="text">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input required="" name="address" id="address"
                                            value="<?php echo $invo->address; ?>" class="form-control" type="text">
                                    </div>
                                </div>

                                <input type="hidden" value="<?php echo $invo->patient_id; ?>" name="patient_id"
                                    id="patient_id">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" size="50" name="date" id="date" required=""
                                            value="<?php echo $invo->date_time; ?>" type="text">
                                    </div>
                                </div>
                                ...
                                <tbody id="addinvoiceItem">
                                    ...
                                    foreach ($invo_product as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input name="product_name" value="<?php echo $value->service_name; ?>"
                                                    onkeypress="invoice_productList(<?php echo $i ?>);"
                                                    class="form-control productSelection" placeholder="Service Name"
                                                    required="" id="product_name" type="text">
                                                <input class="autocomplete_hidden_value product_id_1"
                                                    value="<?php echo @$value->product_id; ?>" name="product_id[]"
                                            ...
                                            <td>
                                                <input name="product_quantity[]"
                                                    ...
                                                    value="<?php echo $value->quantity; ?>" min="1" type="number">
                                            </td>

                                            <td>
                                                <input name="product_rate[]" readonly="" value="<?php echo $value->price; ?>"
                                            ...
                                            <!-- Discount -->
                                            <td>
                                                <input name="discount[]" onkeyup="quantity_calculate(<?php echo $i ?>);"
                                                    id="discount_<?php echo $i; ?>" class="form-control text-right"
                                                    placeholder="Discount" value="<?php echo $value->discount; ?>" min="0"
                                                    type="number">
                                            </td>
                                            ...
                                            <td>
                                                <input class="total_price form-control text-right" name="total_price[]"
                                                    ...
                                                    value="<?php echo $value->grand_price; ?>" tabindex="-1"
                                                    readonly="readonly" type="text">
                                            </td>

                                            <td>
                                                <!-- Tax calculate start-->
                                                <input id="total_tax_<?php echo $i; ?>" class="total_tax_1"
                                                    value="<?php echo $value->tax; ?>" type="hidden">
                                                <input id="all_tax_<?php echo $i; ?>" class="total_tax"
                                                    value="<?php echo $value->tax; ?>" type="hidden">
                                                <!-- Tax calculate end -->
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <input id="total_tax_ammount" tabindex="-1" class="form-control text-right"
                                                name="total_tax" value="<?php echo $invo->total_tax; ?>"
                                                readonly="readonly" type="text">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <input id="paidAmount" onkeyup="invoice_paidamount();" tabindex="-1"
                                                ...
                                                value="<?php echo $invo->paid; ?>" type="text">
                                        </td>
                                    </tr>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea name="payment_notes" class="form-control"
                                            placeholder="<?php echo display('payment_notes') ?>"><?php echo $invo->payment_notes; ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea name="payment_method_notes" class="form-control"
                                            placeholder="<?php echo display('payment_method_notes') ?>"><?php echo @$invo->payment_method_notes; ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
