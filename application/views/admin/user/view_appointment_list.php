                                    ...
                                    <tr <?php echo ($result) ? 'style="background-color:  rgb(19, 203, 21)"' : '' ?>>
                                        ...
                                        <td class="text-center" style="width: 100px;">
                                            <a class="btn btn-xs btn-success" data-original-title="View Appointment"
                                                target="_blank"
                                                href="<?php echo base_url(); ?>admin/user/Basic_controller/my_appointment/<?php echo $value->appointment_id; ?>"><i
                                            ...
                                            <?php if ($result) { ?>
                                                <a class="btn btn-xs btn-primary" target="_blank"
                                                    href="<?php echo base_url(); ?>admin/user/Prescription_controller/my_prescription/<?php echo $value->appointment_id; ?>"><i
