                ...
                <div class="review-block">
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                           ...
                           <div ><a href="<?php echo base_url()?>History_controller/patient_medical_info/<?php echo @$patient_info->patient_id;?>" class="btn btn-success" target="_blank"><i class="ti-alert m-r-5"></i>Click to see medical info</a></div><br>
