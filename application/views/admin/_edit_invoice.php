...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <ol class="breadcrumb">
                <li class="active"><a
                        href="<?php echo base_url(); ?>admin/Dashboard"><?php echo display('deashbord'); ?></a></li>
            </ol>
        </div>
    </section>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input required="" value="<?php echo $invo->family_name; ?>"
                                                name="patient_name" id="patient_name" class="form-control" type="text">
                                        </div>
                                    </div>
                                ...
                                <table class="table table-bordered table-hover" id="normalinvoice">
                                    ...
                                    <tbody id="addinvoiceItem">
                                        ...
                                        foreach ($invo_product as $value) {
                                            ...
                                            <tr>
                                                <input type="hidden" name="inv_p_id[]"
                                                    value="<?php echo @$value->inv_p_id; ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <input id="total_tax_ammount" tabindex="-1"
                                                    ...
                                                    value="<?php echo $invo->total_tax; ?>" readonly="readonly"
                                                    type="text">
                                            </td>
                                        </tr>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="payment_notes" class="form-control"
                                                placeholder="Payment Notes"><?php echo $invo->payment_notes; ?></textarea>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="date" class="col-sm-4 col-form-label"> <i
                                                class="text-danger">*</i></label>
                                        <div class="col-sm-8">
