            ...
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    ...
                    <div class="panel-heading no-print">
                        <div class="btn-group">
                            <a class="btn btn-success" href="<?php echo base_url(); ?>admin/Invoice"> <i
                            ...
                            <tbody>
                                ...
                                foreach ($invo as $value) { ?>
                                    <tr>
                                        ...
                                        <td class="center">
                                            <a href="<?php echo base_url(); ?>admin/Invoice/invoice_view/<?php echo $value->invoice_id; ?>"
                                                class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a>
                                            <a href="<?php echo base_url(); ?>admin/Invoice/edit_invoice/<?php echo $value->invoice_id; ?>"
                                                class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a>
                                            <a href="<?php echo base_url(); ?>admin/Invoice/delete/<?php echo $value->invoice_id; ?>"
