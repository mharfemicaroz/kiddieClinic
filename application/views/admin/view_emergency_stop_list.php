                                ...
                                <tbody>
                                    ...
                                    foreach ($stop_info as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url(); ?>admin/Emergency_stop_controller/edit_emergency_stop/<?php echo $value->stop_id; ?>"
                                                    class="btn  btn-xs btn-info">
                                                    <i class="fa fa-edit"></i> </a>
                                                <a href="<?php echo base_url(); ?>admin/Emergency_stop_controller/delete_emergency_stop/<?php echo $value->stop_id; ?>"
