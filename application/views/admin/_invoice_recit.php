            ...
            <div class="panel panel-bd">
                <div id="printableArea">
                    ...
                    <table>
                            <tr>
                                <td>
                                <img src="<?php echo @$logo->picture;?>" width="128px!important" height="128px!important" class="img img-responsive" alt="" style="margin-bottom:20px">
                                    <h1>Doki Jong's Kiddie Clinic</h1>
                                    <h3>(Herminegeldo H. Mangmang, Jr., M.D. DPPS.)</h3>
                                </td>
                                <td>
                                    <strong>Rivera Medical Center Inc</strong><br>
