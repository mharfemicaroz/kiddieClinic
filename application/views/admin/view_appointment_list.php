            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bd">
                    <div class="panel-heading">
                        <div><a href="<?php echo base_url(); ?>admin/Appointment_controller"
                                        ...
                                        <td class="text-center" style="width: 100px;">
                                            ...
                                            <?php if ($result) { ?>
                                                <a class="btn btn-xs btn-primary" target="_blank"
                                                    href="<?php echo base_url(); ?>admin/Prescription_controller/my_prescription/<?php echo $value->appointment_id; ?>"><i
