            ...
            <div class="col-sm-12">
                ...
                <div class="panel panel-bd panel-form">
                    ...
                    <div class="panel-heading">
                        <div><a href="<?php echo base_url(); ?>admin/doctor/Patient_controller/create_new_patient"
                                class="btn btn-success pull-right">Create New Patient</a></div>
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" id="date" onchange="loadSchedul(this.value);"
                                            value="<?php echo set_value('date'); ?>" name="date"
                                ...
                                <input type="hidden" id="doctor_id"
                                    value="<?php echo $this->session->userdata('doctor_id'); ?>" name="doctor_id">
