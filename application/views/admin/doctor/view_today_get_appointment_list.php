                                ...
                                foreach (@$appointmaent_info as $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-xs btn-primary" data-original-title="View Prescription"
                                                target="_blank"
            ...
            <div class="modal-body form">
                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input name="to" id="to" placeholder="Phone Number" class="form-control" required="1"
                                type="text">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" disabled name="gateway" class="form-control"
                                value="<?php echo $gateway_list->provider_name ?>">
                        </div>
                    </div>
