            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bd">
                    <div class="panel-heading">
                        <div><a href="<?php echo base_url('admin/doctor/Appointment_controller') ?>"
                                class="btn btn-success pull-right"><?php echo display('create_appointment') ?></a></div>
                                ...
                                foreach (@$appointmaent_info as $value) {
                                    ...
                                    <tr <?php echo ($result) ? 'style="background-color: rgb(19, 203, 21)"' : '' ?>>
                                        ...
                                        <td class="text-center" style="width: 100px;">
                                            <a class="btn btn-xs btn-success" data-original-title="View Appointment"
                                                target="_blank"
                                                href="<?php echo base_url(); ?>admin/Basic_controller/my_appointment/<?php echo $value->appointment_id; ?>"><i
                                                    class="fa fa-print"></i></a>
                                            <a class="btn btn-xs btn-info" data-original-title="View History"
                                                target="_blank"
                                                href="<?php echo base_url(); ?>History_controller/patient_history/<?php echo $value->patient_id; ?>"><i
                                                    class="fa fa-history" aria-hidden="true"></i></a>
                                            <?php if ($result) { ?>
                                                <a class="btn btn-xs btn-primary" target="_blank"
                                                    href="<?php echo base_url(); ?>admin/doctor/Prescription_controller/my_prescription/<?php echo $result->prescription_id; ?>"><i
                                                        class="fa fa-indent" aria-hidden="true"></i></a>
                                            <?php } else { ?>
                                                <a class="btn btn-xs btn-primary"
                                                    href="<?php echo base_url(); ?>admin/doctor/Prescription_controller/create_prescription/<?php echo $value->appointment_id; ?>"><i
        ...
        <div class="modal-content">
            ...
            <div class="modal-body form">
                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input name="to" id="to" placeholder="<?php echo display('phone_number'); ?>"
                                class="form-control" required="1" type="text">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input name="name" placeholder="<?php echo display('patient_name'); ?>" class="form-control"
                                type="text">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" disabled name="gateway" value="<?php echo $gateway_list->provider_name ?>"
                                class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <select class="form-control" name="teamplate_id" id="tmp" onchange="getTeamplate()"
                                required>
            ...
            <div class="modal-footer">
                <button type="button" id="btnSave" onclick="save()"
                    class="btn btn-primary"><?php echo display('send'); ?></button>
                <button type="button" class="btn btn-danger"
                    data-dismiss="modal"><?php echo display('reset'); ?></button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->