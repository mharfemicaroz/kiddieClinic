            ...
            <div class="col-sm-12">
                ...
                <div class="panel panel-bd thumbnail">
                    ...
                    <div class="panel-heading no-print">
                        <div class="btn-group">
                            <a class="btn btn-success" href="<?php echo base_url(); ?>admin/doctor/Invoice"> <i
                                    class="fa fa-plus"></i> <?php echo display('add_new_invoice') ?> </a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                foreach ($invo as $value) { ?>
                                    <tr>
                                        ...
                                        <td class="center">
                                            <a href="<?php echo base_url(); ?>admin/doctor/Invoice/invoice_view/<?php echo $value->invoice_id; ?>"
                                                class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a>
                                            <a href="<?php echo base_url(); ?>admin/doctor/Invoice/edit_invoice/<?php echo $value->invoice_id; ?>"
                                                class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a>
                                            <a href="<?php echo base_url(); ?>admin/doctor/Invoice/delete/<?php echo $value->invoice_id; ?>"
