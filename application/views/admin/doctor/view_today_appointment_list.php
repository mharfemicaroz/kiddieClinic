                                        ...
                                        <td class="text-center">
                                            <?php if (empty($result) and $this->session->userdata('user_type') == 1) { ?>
                                                <a class="btn btn-xs btn-primary"
                                                    href="<?php echo base_url(); ?>admin/Prescription_controller/create_prescription/<?php echo $value->appointment_id; ?>"><i
            ...
            <div class="modal-body form">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input name="gateway" value="<?php echo $gateway_list->provider_name; ?>"
