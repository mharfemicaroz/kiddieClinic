                        ...
                        <?php echo form_open('admin/doctor/Prescription_controller/save_prescription',array('target'=>'_blank'));?>
                            <div class="panel panel-bd prescription-table">
                                        ...
                                        <div class="col-sm-8 col-sm-offset-2">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7 autocomplete-container">
                                                    <input class="form-control" id="chief-complaint" type="text" name="chief_complain" oninput="showSuggestions(this.value)">
                                ...
                                <div class="panel-footer text-right">
                                    ...
                                    <button type="submit" class="btn btn-success" onsubmit="saveComplaint(event)"><?php echo display('submit')?></button>
                                </div>
                            </div>
                            <?php echo form_close();?>
                        </div>
