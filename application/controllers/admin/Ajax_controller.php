...
class Ajax_controller extends CI_Controller
{
  ...
  public function get_patinet_name($phone = NULL)
  {
    ...
    if (!empty($result)) {
      echo $result->family_name . ', ' . $result->given_name . '<input type="hidden" name="patient_id" value="' . $result->patient_id . '">' . '<input type="hidden" name="phone" value="' . $result->patient_phone . '">';
    } else {
      echo 0;
    }
  }
